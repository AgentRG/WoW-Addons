...
if (locale == "enUS" or locale == 'enGB') then
    ...
    L["DEBUGGER_DESCRIPTION"] = "Enable the debugger for event handling and other functions."
    L["ENABLE_AUDIO_CUE"] = "Enable Audio Cue"
    L["AUDIO_CUE_DESCRIPTION"] = "Play a sound when the target is casting an interruptible spell."
    L["PROC"] = "Proc"
    L["GLOW"] = "Glow"
    L["PIXEL"] = "Pixel"
    L["CAST"] = "Cast"
...
elseif locale == "deDE" then
    ...
    L["DEBUGGER_DESCRIPTION"] = "Aktiviere den Debugger für die Ereignisverarbeitung und andere Funktionen."
    L["ENABLE_AUDIO_CUE"] = "Audio-Hinweis aktivieren"
    L["AUDIO_CUE_DESCRIPTION"] = "Spiele einen Ton ab, wenn das Ziel einen unterbrechbaren Zauber wirkt."
    L["PROC"] = "Proc"
    L["GLOW"] = "Leuchten"
    L["PIXEL"] = "Pixel"
    L["CAST"] = "Wirken"
...
elseif locale == "esMX" then
    ...
    L["DEBUGGER_DESCRIPTION"] = "Habilita el depurador para el manejo de eventos y otras funciones."
    L["ENABLE_AUDIO_CUE"] = "Habilitar señal de audio"
    L["AUDIO_CUE_DESCRIPTION"] = "Reproduce un sonido cuando el objetivo esté lanzando un hechizo interrumpible."
    L["PROC"] = "Proc"
    L["GLOW"] = "Brillo"
    L["PIXEL"] = "Píxel"
    L["CAST"] = "Lanzar"
...
elseif locale == 'ptBR' then
    ...
    L["DEBUGGER_DESCRIPTION"] = "Habilite o depurador para o gerenciamento de eventos e outras funções."
    L["ENABLE_AUDIO_CUE"] = "Ativar Sinal de Áudio"
    L["AUDIO_CUE_DESCRIPTION"] = "Reproduza um som quando o alvo estiver lançando um feitiço interrompível."
    L["PROC"] = "Proc"
    L["GLOW"] = "Brilho"
    L["PIXEL"] = "Pixel"
    L["CAST"] = "Lançar"
...
elseif (locale == 'zhCN' or locale == 'enCN') then
    ...
    L["DEBUGGER_DESCRIPTION"] = "启用调试器以处理事件和其他功能。"
    L["ENABLE_AUDIO_CUE"] = "启用音频提示"
    L["AUDIO_CUE_DESCRIPTION"] = "当目标施放可打断法术时播放声音。"
    L["PROC"] = "触发"
    L["GLOW"] = "发光"
    L["PIXEL"] = "像素"
    L["CAST"] = "施法"
...
elseif locale == 'frFR' then
    ...
    L["DEBUGGER_DESCRIPTION"] = "Activez le débogueur pour la gestion des événements et autres fonctions."
    L["ENABLE_AUDIO_CUE"] = "Activer le signal audio"
    L["AUDIO_CUE_DESCRIPTION"] = "Jouez un son lorsque la cible lance un sort interrompable."
    L["PROC"] = "Proc"
    L["GLOW"] = "Lueur"
    L["PIXEL"] = "Pixel"
    L["CAST"] = "Incantation"
...
elseif locale == 'itIT' then
    ...
    L["DEBUGGER_DESCRIPTION"] = "Abilita il debugger per la gestione degli eventi e altre funzioni."
    L["ENABLE_AUDIO_CUE"] = "Abilita segnale audio"
    L["AUDIO_CUE_DESCRIPTION"] = "Riproduci un suono quando il bersaglio sta lanciando un incantesimo interruppibile."
    L["PROC"] = "Proc"
    L["GLOW"] = "Bagliore"
    L["PIXEL"] = "Pixel"
    L["CAST"] = "Lancio"
...
elseif locale == 'ruRU' then
    ...
    L["DEBUGGER_DESCRIPTION"] = "Включите отладчик для обработки событий и других функций."
    L["ENABLE_AUDIO_CUE"] = "Включить аудиосигнал"
    L["AUDIO_CUE_DESCRIPTION"] = "Воспроизведите звук, когда цель выполняет прерываемое заклинание."
    L["PROC"] = "Прок"
    L["GLOW"] = "Свечение"
    L["PIXEL"] = "Пиксель"
    L["CAST"] = "Применить"
...
elseif locale == 'ptPT' then
    ...
    L["CANCEL"] = "Cancelar"
    L["ENABLE_DEBUGGER"] = "Ativar Depurador"
    L["DEBUGGER_DESCRIPTION"] = "Ative o depurador para o gerenciamento de eventos e outras funções."
    L["ENABLE_AUDIO_CUE"] = "Ativar Sinal Áudio"
    L["AUDIO_CUE_DESCRIPTION"] = "Reproduza um som quando o alvo estiver a lançar um feitiço interrompível."
    L["PROC"] = "Proc"
    L["GLOW"] = "Brilho"
    L["PIXEL"] = "Pixel"
    L["CAST"] = "Lançar"
...
elseif locale == 'koKR' then
    ...
    L["DEBUGGER_DESCRIPTION"] = "이벤트 처리 및 기타 기능을 위해 디버거를 활성화하세요."
    L["ENABLE_AUDIO_CUE"] = "오디오 신호 활성화"
    L["AUDIO_CUE_DESCRIPTION"] = "대상이 인터럽트 가능한 주문을 시전할 때 소리를 재생합니다."
    L["PROC"] = "발동"
    L["GLOW"] = "광채"
    L["PIXEL"] = "픽셀"
    L["CAST"] = "시전"
...
elseif locale == 'esES' then
    ...
    L["CANCEL"] = "Cancelar"
    L["ENABLE_DEBUGGER"] = "Habilitar depurador"
    L["DEBUGGER_DESCRIPTION"] = "Activa el depurador para la gestión de eventos y otras funciones."
    L["ENABLE_AUDIO_CUE"] = "Habilitar señal de audio"
    L["AUDIO_CUE_DESCRIPTION"] = "Reproduce un sonido cuando el objetivo lance un hechizo interrumpible."
    L["PROC"] = "Proc"
    L["GLOW"] = "Brillo"
    L["PIXEL"] = "Píxel"
    L["CAST"] = "Lanzar"
...
elseif (locale == 'zhTW' or locale == 'enTW') then
    ...
    L["DEBUGGER_DESCRIPTION"] = "啟用調試器以處理事件和其他功能。"
    L["ENABLE_AUDIO_CUE"] = "啟用音效提示"
    L["AUDIO_CUE_DESCRIPTION"] = "當目標施放可打斷法術時播放聲音。"
    L["PROC"] = "觸發"
    L["GLOW"] = "光暈"
    L["PIXEL"] = "像素"
    L["CAST"] = "施法"
